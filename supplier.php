...
if (isset($_POST['submit'])) {
    ...
    if ($sql) {
        echo "<script>alert('Your detail submitted');window.location.href='product';</script>";
    } else {
                ...
                <div class="container">
                    <div class="store store-wcfm-banner">
                        <figure class="store-media">
                            <img src="assets/images/pages/coming/2.png" alt="Vendor" width="1240" height="460"
                                    ...
                                    <div class="widget widget-collapsible widget-categories">
                                        ...
                                        <ul class="widget-body filter-items search-ul">
                                            <form class="form contact-us-form" action="" method="POST">
                                                <div class="row">
                                                    ...
                                                    <div class="form-group col-lg-12">
                                                        ...
                                                        <select name="main_category" id="main_category"
                                                            style="width: 230px; height: 48px; border: 1px solid #da2d5b;border-radius:4px">
                                                            ...
                                                            <option value="Apparel & fashion accessories">Apparel &
                                                                fashion accessories</option>
                                                            <option value="Home furnishing & supplies">Home furnishing &
                                                                supplies</option>
                                                ...
                                                <button type="submit" name="search" class="btn btn-dark btn-rounded"
                                                    style="width: 230px;margin-top:10px">Find Products</button>
                                            </form>
                        ...
                        <div class="main-content">
                            <div class="tab tab-nav-underline tab-nav-boxed tab-vendor-wcfm">
                                <ul class="nav nav-tabs" style="background-color: #da2d5b;padding-left:5px">
                                    ...
                                    <li class="nav-item">
                                        <a href="#tab-2" class="nav-link">Buyer</a>
                                    </li>
                                    <li class="nav-item">
                                        <a href="#tab-3" class="nav-link active ml-3">Suppliers</a>
                                    </li>
                                ...
                                <div class="tab-content">
                                    <div class="tab-pane" id="tab-1">
                                        <div class="product-wrapper row cols-md-12 cols-sm-12 cols-12">
                                            <?php
                                                        // Get the current page number (for pagination, if needed)
                                                        $page = isset($_GET['page']) ? (int)$_GET['page'] : 1;
                                                        $limit = 10; // Define the number of results per page
                                                        $offset = ($page - 1) * $limit;

                                                        // Get the search term if it's set
                                                        $searchTerm = isset($_GET['search']) ? mysqli_real_escape_string($conn, $_GET['search']) : '';

                                                        // Query to fetch buyer details with a search term and pagination
                                                        if ($searchTerm) {
                                                            $query = mysqli_query($conn, "SELECT * FROM tbl_product WHERE product_name LIKE '%$searchTerm%' LIMIT $limit OFFSET $offset");
                                                        } else {
                                                            $query = mysqli_query($conn, "SELECT * FROM tbl_product LIMIT $limit OFFSET $offset");
                                                        }
                                            ...
                                            <article class="post row post-listing mb-md-5 mb-6 pb-2 overlay-zoom">
                                                <figure class="post-media br-sm col-lg-3 col-12">
                                                    <a
                                                        href="contact-us?product_name=<?php echo urlencode($row['product_name']); ?>">
                                                        <img src="Adminstrator/img/<?php echo $row['image']; ?>"
                                                            width="930" height="400" alt="product"
                                                            style="height: 220px;">
                                                    </a>
                                                </figure>
                                                <div class="post-details col-lg-9 col-12">
                                                    ...
                                                    <div class="col-lg-3 bottom-back mt-4">
                                                        ...
                                                        <button class="btn btn-dark btn-rounded btn-sm ml-lg-2 btn-cart"
                                                            onclick="openPopup()"> Get Query Now <i
                                                                class="w-icon-shipping"></i></button>
                                            ...
                                            <?php
                                                ...
                                                echo "<div class='alert alert-info'>No Product found matching your search.</div>";
                                            }
                                            ?>
                                        </div>
                                        ...
                                        <div class="toolbox toolbox-pagination justify-content-between">
                                            <p class="showing-info mb-2 mb-sm-0">
                                                Showing <span>
                                                    <?php echo ($start + 1); ?>-
                                                    <?php echo min($start + $products_per_page, $total_products); ?>
                                                </span>
                                                of
                                            ...
                                            <ul class="pagination">
                                                ...
                                                <!-- Next Page -->
                                                <li
                                                    class="next <?php echo ($page >= $total_pages) ? 'disabled' : ''; ?>">
                                                    <a href="<?php echo ($page < $total_pages) ? '?page=' . ($page + 1) : '#'; ?>"
                                                        <?php echo ($page>= $total_pages) ? 'tabindex="-1"
                                                        aria-disabled="true"' : ''; ?>>
...
// Query to fetch buyer details with a search term and pagination
if ($searchTerm) {
    $query = mysqli_query($conn, "SELECT * FROM tbl_buyer WHERE heading LIKE '%$searchTerm%' LIMIT $limit OFFSET $offset");
} else {
    $query = mysqli_query($conn, "SELECT * FROM tbl_buyer LIMIT $limit OFFSET $offset");
}

// Check if there are any buyers
if (mysqli_num_rows($query) > 0) {
    while ($row = mysqli_fetch_array($query)) {
        // Mask or display details based on login
        $buyerCompany = $isLoggedIn ? htmlspecialchars($row['company_name']) : 'XXX XXX XXX XXX';
        $buyerContact = $isLoggedIn ? htmlspecialchars($row['contact']) : 'XXX XXX XXX XXX';
        $buyerName = $isLoggedIn ? htmlspecialchars($row['heading']) : 'XXX XXX XXX XXX';
?>
                                                        <div class="mb-4 p-3 rounded shadow"
                                                            style="background-color: #f8f9fa;">
                                                            <div
                                                                class="d-flex justify-content-between align-items-center mb-3">
                                                                <img src="Adminstrator/img/<?php echo htmlspecialchars($row['flag']); ?>"
                                                                    alt="Product Image"
                                                                    style="width: 50px; height: 35px; margin-right: 8px;">
                                                                <h5 class="card-title mb-0 align-items-left">
                                                                    <?php echo htmlspecialchars($row['heading']); ?>
                                                                </h5>
                                                                <span class="badge bg-warning text-dark fw-bold">VIP
                                                                    Buyer</span>
                                                            </div>
                                                                ...
                                                                <div class="col-md-3 col-6">
                                                                    <div class="d-flex flex-column align-items-center">
                                                                        <div class="text-end mt-4">
                                                                            <?php if ($isLoggedIn): ?>
                                                                            <button class="btn btn-success">Contact
                                                                                Buyer</button>
                                                                            <?php else: ?>
    ...
    echo "<div class='alert alert-info'>No buyers found matching your search.</div>";
}
?>
                                    ...
                                    <div class="tab-pane active" id="tab-3">
                                        <div class="product-wrapper row">
                                            <?php
                                                        ...
                                                        // Query to fetch buyer details with a search term and pagination
                                                        if ($searchTerm) {
                                                            $query = mysqli_query($conn, "SELECT * FROM  tbl_supply WHERE business_type1 LIKE '%$searchTerm%' LIMIT $limit OFFSET $offset");
                                                        } else {
                                                            $query = mysqli_query($conn, "SELECT * FROM  tbl_supply LIMIT $limit OFFSET $offset");
                                                        }
                                            ...
                                            <div class="supplier-section mb-4 p-3 rounded"
                                                style="background-color: #f8f9fa;">
                                                <!-- Added background color and bottom margin -->
                                                <div class="row">
                                                    <div class="col-lg-2">
                                                        <img src="assets/images/demos/demo14/site-icon.svg"
                                                            alt="Supplier Icon" srcset=""
                                                    ...
                                                    <div class="col-lg-10">
                                                        ...
                                                        <div class="post-meta">
                                                            ...
                                                            <a href="#" class="post-author">
                                                                <?php echo htmlspecialchars($row['suppliername']); ?>
                                                            </a> &nbsp;&nbsp;
                                                            <i class="w-icon-map-marker"></i>
                                                            <a href="#" class="post-date">
                                                                <?php echo htmlspecialchars($row['country']); ?>
                                                ...
                                                <div class="row product-wrap mt-3">
                                                    <div class="col-lg-9">
                                                        ...
                                                        <div class="post-meta">
                                                            ...
                                                            &nbsp;&nbsp;
                                                            <a href="#" class="post-date">
                                                                <?php echo htmlspecialchars($row['business_type1']); ?>
                                                                |
                                                                <?php echo htmlspecialchars($row['business_type2']); ?>
                                                            </a>
                                                            <br>
                                                            <a href="#" class="post-author">Major Markets-</a>
                                                            &nbsp;&nbsp;
                                                            <a href="#" class="post-date">WorldWide |
                                                                <?php echo htmlspecialchars($row['major_market']); ?>
                                                            </a>
                                                        </div>
                                                    </div>
                                            ...
                                            <?php
                                                            ...
                                                            echo "<div class='alert alert-info'>No suppliers found matching your search.</div>";
                                                        }
                                                        ?>
                                        </div>
                                    </div>
                ...
                <div class="row cols-xl-12 cols-lg-5 cols-md-4 cols-sm-3 cols-2">
                    <div class="vendor-brand-wrap mb-8">
                        <div class="vendor-brand">
                            <a href="country">
                                <figure class="">
                                    <img src="assets\video\flags\ad.svg" alt="Brand" width="150" height="150"
                    ...
                    <div class="vendor-brand-wrap mb-8">
                        <div class="vendor-brand">
                            <a href="country">
                                <figure class="">
                                    <img src="assets\video\flags\az.svg" alt="Brand" width="150" height="150"
                                        style="width: 50px;height: 50px;" />
                                </figure>
                    ...
                    <div class="vendor-brand-wrap mb-8">
                        <div class="vendor-brand">
                            <a href="country">
                                <figure class="">
                                    <img src="assets\video\flags\af.svg" alt="Brand" width="150" height="150"
                                        style="width: 50px;height: 50px;" />
                                </figure>
                    ...
                    <div class="vendor-brand-wrap mb-8">
                        <div class="vendor-brand">
                            <a href="country">
                                <figure class="">
                                    <img src="assets\video\flags\aw.svg" alt="Brand" width="150" height="150"
                                        style="width: 50px;height: 50px;" />
                                </figure>
                    ...
                    <div class="vendor-brand-wrap mb-8">
                        <div class="vendor-brand">
                            <a href="country">
                                <figure class="">
                                    <img src="assets\video\flags\ai.svg" alt="Brand" width="150" height="150"
                                        style="width: 50px;height: 50px;" />
                                </figure>
                    ...
                    <div class="vendor-brand-wrap mb-8">
                        <div class="vendor-brand">
                            <a href="country">
                                <figure class="">
                                    <img src="assets\video\flags\al.svg" alt="Brand" width="150" height="150"
                                        style="width: 50px;height: 50px;" />
                                </figure>
                    ...
                    <div class="vendor-brand-wrap mb-8">
                        <div class="vendor-brand">
                            <a href="country">
                                <figure class="">
                                    <img src="assets\video\flags\am.svg" alt="Brand" width="150" height="150"
                                        style="width: 50px;height: 50px;" />
                                </figure>
                    ...
                    <div class="vendor-brand-wrap mb-8">
                        <div class="vendor-brand">
                            <a href="country">
                                <figure class="">
                                    <img src="assets\video\flags\ao.svg" alt="Brand" width="150" height="150"
                                        style="width: 50px;height: 50px;" />
                                </figure>
                    ...
                    <div class="vendor-brand-wrap mb-8">
                        <div class="vendor-brand">
                            <a href="country">
                                <figure class="">
                                    <img src="assets\video\flags\aq.svg" alt="Brand" width="150" height="150"
                                        style="width: 50px;height: 50px;" />
                                </figure>
                    ...
                    <div class="vendor-brand-wrap mb-8">
                        <div class="vendor-brand">
                            <a href="country">
                                <figure class="">
                                    <img src="assets\video\flags\ar.svg" alt="Brand" width="150" height="150"
                                        style="width: 50px;height: 50px;" />
                                </figure>
                    ...
                    <div class="vendor-brand-wrap mb-8">
                        <div class="vendor-brand">
                            <a href="country">
                                <figure class="">
                                    <img src="assets\video\flags\as.svg" alt="Brand" width="150" height="150"
                                        style="width: 50px;height: 50px;" />
                                </figure>
                    ...
                    <div class="vendor-brand-wrap mb-8">
                        <div class="vendor-brand">
                            <a href="country">
                                <figure class="">
                                    <img src="assets\video\flags\at.svg" alt="Brand" width="150" height="150"
                                        style="width: 50px;height: 50px;" />
                                </figure>
    ...
    <div class="popup-overlay" id="popup">
        <div class="popup p-4 shadow-lg bg-white rounded">
            ...
            <div class="row">
                ...
                <div class="col-lg-12">
                     <input type="text" class="form-control form-control-md" name="about"
                        placeholder="Let us know what you need*">
                </div>
                <button class="btn btn-dark btn-block btn-rounded w-100 mt-4" type="submit" name="submit">Post Buy
                    Inquiry <i
                                                                class="w-icon-shipping"></i></button>
            </div>
             </form>
