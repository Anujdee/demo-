            ...
            <div class="main-content flex min-h-screen flex-col">
                ...
                <div class="dvanimation animate__animated p-6"  >
                    ...
                    <div x-data="invoiceList">
                        ...
                        <div class="panel">
                                    <div class="mb-5 text-lg font-bold">D2C Portal Enquiry List</div>
                                    <div class="table-responsive">
                                        <table>
                                            <thead>
                                                <tr>
                                                    
                                                    <th class="ltr:rounded-l-md rtl:rounded-r-md">First Name</th>
                                                    <th>Last Name</th>
                                                    <th>Email</th>
                                                    <th>Phone</th>
                                                    <th>Subject</th>
				...
				$query=mysqli_query($conn,"SELECT * FROM  tbl_d2c");?>
				<?php while($row=mysqli_fetch_array($query)){ 	?>
                                                <tr>
                                                    <td class="font-semibold"><?php echo $row['first_name'];?></td>
                                                    <td><?php echo $row['last_name'];?></td>
                                                    <td class="whitespace-nowrap"><?php echo $row['email'];?></td>
                                                    <td class="whitespace-nowrap"><?php echo $row['phone'];?></td>
