...
if (isset($_POST['submit'])) {
    ...
    $pbuyers = $_POST['buyers'];
    $pabout = $_POST['about'];
    $pcontact = $_POST['contact'];
    $pdate = $_POST['date'];
     
    $sql = mysqli_query($conn, "INSERT INTO `tbl_buyer` (`flag`,`heading`, `company_name`, `join_date`, `contact`, `passage`)
     VALUES ('$file_name','$pbuyers','$pcompany','$pdate','$pcontact','$pabout')");
    // if ($sql) {
...
if(move_uploaded_file($tempname, $folder)){
    echo "<script>alert('Your details has been submitted !');window.location.href='view-buyer';</script>";
} else {
                ...
                <div>
                    ...
                    <div class="pt-5">
                        <div class="flex flex-wrap items-center justify-between gap-4">
                            <h2 class="text-xl mb-2">Add New Buyers</h2>
                                        ...
                                        <div class="flex flex-col sm:flex-row">
                                            ...
                                            <div class="grid flex-1 grid-cols-1 gap-5 sm:grid-cols-2">
                                                <div>
                                                    ...
                                                    <input id="name" name="company" type="text" required placeholder="Company Name" class="form-input" />
                                                </div>
                                                <div>
                                                    <label for="profession">Product Name</label>
                                                    <input name="buyers" id="profession" type="text" required placeholder="Product Name" class="form-input" />
                                                </div>
                                                 <div>
                                                    <label for="address">Buyer Name</label>
                                                    <input name="date" id="datePicker"  required type="text" placeholder="Buyer Name" class="form-input" />
                                                </div>
                                                <div>
                                                    <label for="profession">About Product</label>
                                                    <input name="about" id="profession" type="text" required placeholder="About product" class="form-input" />
                                                </div>
                                                <div>
                                                    <label for="profession">Contact Number</label>
                                                    <input name="contact" id="profession" type="number" required placeholder="Contact Number" class="form-input" />
                                                </div>
                                                <div>
                                                    <label for="profession">Country Flag Image</label>
                                                    <input name="fimage" id="profession" type="file" required placeholder="image" class="form-input" />
                                                </div>
