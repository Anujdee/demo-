         ...
         <div class="relative flex w-full items-center bg-white px-5 py-2.5 dark:bg-[#0e1726]">
             <div class="horizontal-logo flex items-center justify-between ltr:mr-2 rtl:ml-2 lg:hidden">
                 <p class="main-logo flex shrink-0 items-center">
                     <img class="inline w-8 ltr:-ml-1 rtl:-mr-1" src="assets/images/1.svg" alt="image" style="width: 150px;"
                         </p>
                     ...
                     <ul
                         ...
                         <li>
                             <div class="flex items-center px-4 py-4">
                                 <div class="flex-none">
                                     <img class="h-10 w-10 rounded-md object-cover" src="assets/images/site-icon.svg" alt="image" />
                                 </div>
                                 <div class="truncate ltr:pl-4 rtl:pr-4">
                                     <h4 class="text-base">
                                         Global Connection<span class="rounded bg-success-light px-1 text-xs text-success ltr:ml-2 rtl:ml-2">21</span>
                                     </h4>
                                     <a
                         ...
                         <li>
                             <a href="Forgotpassword" class="dark:hover:text-white" @click="toggle">
                                 <svg
