...
if (isset($_POST['submit'])) {
    ...
    $sql = mysqli_query($conn, "INSERT INTO `banners` (`banner`) VALUES ('$file_name')");
    // if ($sql) {
    ...
    if (move_uploaded_file($tempname, $folder)) {
        echo "<script>alert('Your image has been submitted !');window.location.href='view-banner';</script>";
    } else {
