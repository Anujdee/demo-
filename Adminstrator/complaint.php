            ...
            <div class="main-content flex min-h-screen flex-col">
                ...
                <div class="dvanimation animate__animated p-6"  >
                    ...
                    <div x-data="invoiceList">
                        ...
                        <div class="flex flex-wrap items-center justify-between gap-4">
                            <h2 class="text-xl mb-2">User Complaint</h2>
				...
				<?php while($row=mysqli_fetch_array($query)){ 	?>
                                                <tr>
                                                    ...
                                                    <td class="whitespace-nowrap"><?php echo $row['last_name'];?></td>
                                                    <td class="whitespace-nowrap"><?php echo $row['number'];?></td>
                                                  ...
                                                  <a href="complaint?state_id=<?php echo $row['id'];?>" onclick="return confirm('Are you sure you want to delete this registration?');">
...
{
$a=$_GET['state_id'];
$query=mysqli_query($conn,"DELETE FROM tbl_complaint WHERE id='$a'");
if($query)
{
  echo"<script>alert('Complaint has been deleted');
  window.location.href='complaint';</script>";
}
else
{
  echo"<script>alert('Complaint has not been deleted');window.location.href='complaint';</script>";
}
}
?>
    </body>
