    ...
    >
        ...
        <div class="main-container min-h-screen text-black dark:text-white-dark">
            ...
            <div class="main-content flex min-h-screen flex-col">
                                        ...
                                        <table>
                                            <thead>
                                                <tr>
                                                    ...
                                                    <th class="ltr:rounded-l-md rtl:rounded-r-md">Full Name</th>
                                                    <th>Email Address</th>
                                                    <th>Country</th>
                                                    <th>State</th>
                                                    <th>Country Code</th>
				...
				$query=mysqli_query($conn,"SELECT * FROM  tbl_quotes");?>
				<?php while($row=mysqli_fetch_array($query)){ 	?>
                                                <tr>
                                                    <td class="font-semibold"><?php echo $row['fullname'];?></td>
                                                    <td><?php echo $row['email'];?></td>
                                                    <td class="whitespace-nowrap"><?php echo $row['country'];?></td>
                                                    <td class="whitespace-nowrap"><?php echo $row['state'];?></td>
                                                    <td><?php echo $row['code'];?></td>
                                                    <td><?php echo $row['number'];?></td>
                                                    <td><?php echo $row['product_name'];?></td>
                                                    <td><?php echo $row['product_quantity'];?></td> 
                                                    <td><?php echo $row['product_piece'];?></td>
                                                    <td><?php echo $row['subscriptio'];?></td>
                                                    <td><?php echo $row['CreatedAt'];?></td>
                                                    <td class="text-center">
                                                  
                                                  <a href="Enquiry?state_id=<?php echo $row['CreatedAt'];?>" onclick="return confirm('Are you sure you want to delete this Product?');">
...
if($query)
{
  ...
  window.location.href='Enquiry';</script>";
}
else
{
