    ...
    >
        ...
        <div class="main-container min-h-screen text-black dark:text-white-dark">
            ...
            <div class="main-content flex min-h-screen flex-col">
                ...
                <div class="dvanimation animate__animated p-6"  >
                    ...
                    <div x-data="invoiceList">
                        ...
                        <div class="flex flex-wrap items-center justify-between gap-4">
                            <h2 class="text-xl mb-2">View All Subscription User</h2>
                            <div class="flex w-full flex-col gap-4 sm:w-auto sm:flex-row sm:items-center sm:gap-3">
                                <div class="flex gap-3">
                                    <div>
                                        <a href="add-subscriptions">
				...
				$query=mysqli_query($conn,"SELECT * FROM  tbl_subscription_user");?>
				<?php while($row=mysqli_fetch_array($query)){ 	?>
                                                <tr>
                                                    <td class="font-semibold"><?php echo $row['id'];?></td>
                                                    <td><?php echo $row['subscription_date'];?></td>
                                                    <td class="whitespace-nowrap"><?php echo $row['username'];?></td>
                                                    <td class="whitespace-nowrap"><?php echo $row['password'];?></td>
                                                    <td><?php echo $row['plan_type'];?></td>
                                                    <td class="text-center">
                                                    
                                                         
                                                  <a href="view-subscription-user?state_id=<?php echo $row['id'];?>" onclick="return confirm('Are you sure you want to delete this Subscription User?');">
...
{
$a=$_GET['state_id'];
$query=mysqli_query($conn,"DELETE FROM tbl_subscription_user WHERE id='$a'");
if($query)
{
  echo"<script>alert('Subscription User has been deleted');
  window.location.href='view-subscription-user';</script>";
}
else
{
  echo"<script>alert('Details has not been deleted');window.location.href='view-subscription-user';</script>";
}
}
?>
    </body>
