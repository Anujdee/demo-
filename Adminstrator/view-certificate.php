				...
				<?php while($row=mysqli_fetch_array($query)){ 	?>
                                                <tr>
                                                    <td class="font-semibold"><?php echo $row['id'];?></td>
                                                     <td class="whitespace-nowrap"><?php echo $row['name'];?></td>
                                                    <td class="whitespace-nowrap"><?php echo $row['date_of_issue'];?></td>
                                                  ...
                                                  <a href="view-certificate?state_id=<?php echo $row['id'];?>" onclick="return confirm('Are you sure you want to delete this registration?');">
...
{
$a=$_GET['state_id'];
$query=mysqli_query($conn,"DELETE FROM certificates WHERE id='$a'");
if($query)
{
  echo"<script>alert('Details has been deleted');
  window.location.href='view-certificate';</script>";
}
else
{
  echo"<script>alert('Details has not been deleted');window.location.href='view-certificate';</script>";
}
}
?>
    </body>
