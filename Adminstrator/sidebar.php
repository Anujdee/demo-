            ...
            <nav
                ...
                <div class="h-full bg-white dark:bg-[#0e1726]">
                    <div class="flex items-center justify-between px-4 py-3">
                        <p class="main-logo flex shrink-0 items-center">
                            <img class="ml-[5px] w-8 flex-none"src="assets/images/1.svg" alt="image" style="width: 150px;"
</p>
                        <a
                            href="javascript:;"
                    ...
                    <ul
                                ...
                                <li class="nav-item">
                                    <a href="add-banner" class="group">
                                        ...
                                        <svg
                                            ...
                                            <span class="text-black ltr:pl-3 rtl:pr-3 dark:text-[#506690] dark:group-hover:text-white-dark">Add Banner</span>
                                        </div>
                                    </a>
                                </li>
                                <li class="nav-item">
                                    <a href="view-banner" class="group">
                                        <div class="flex items-center">
                                            <svg
                                                class="shrink-0 group-hover:!text-primary"
                                                width="20"
                                            ...
                                            <span class="text-black ltr:pl-3 rtl:pr-3 dark:text-[#506690] dark:group-hover:text-white-dark">View Banner</span>
                                        </div>
                                    </a>
                                </li>
                                ...
                                <li class="nav-item">
                                    <a href="add-deals" class="group">
                                        ...
                                        <svg
                                            ...
                                            <span class="text-black ltr:pl-3 rtl:pr-3 dark:text-[#506690] dark:group-hover:text-white-dark">Add Deals</span>
                                        </div>
                                    </a>
                                </li>
                                <li class="nav-item">
                                    <a href="view-deals" class="group">
                                        <div class="flex items-center">
                                            <svg
                                                class="shrink-0 group-hover:!text-primary"
                                                width="20"
                                            ...
                                            <span class="text-black ltr:pl-3 rtl:pr-3 dark:text-[#506690] dark:group-hover:text-white-dark">View Deals</span>
                                        </div>
                                    </a>
                                </li>
                        ...
                        <li class="nav-item">
                            <ul>
                                <li class="nav-item">
                                    <a href="Add-Products" class="group">
                                        <div class="flex items-center">
                                        <svg
                                                    class="shrink-0 group-hover:!text-primary"
                                                    width="20"
                                            ...
                                            <span class="text-black ltr:pl-3 rtl:pr-3 dark:text-[#506690] dark:group-hover:text-white-dark">Add Products</span>
                                        </div>
                                    </a>
                                </li>
                                <li class="nav-item">
                                    <a href="View-Products" class="group">
                                        <div class="flex items-center">
                                            <svg
                                                class="shrink-0 group-hover:!text-primary"
                                                width="20"
                                            ...
                                            <span class="text-black ltr:pl-3 rtl:pr-3 dark:text-[#506690] dark:group-hover:text-white-dark">View Products</span>
                                        </div>
                                    </a>
                                </li>
                                ...
                                <li class="nav-item">
                                    <a href="d2cportal" class="group">
                                        <div class="flex items-center">
                                            ...
                                            <span class="text-black ltr:pl-3 rtl:pr-3 dark:text-[#506690] dark:group-hover:text-white-dark">D2C Enquiry</span>
                                        </div>
                                    </a>
                                </li>
                        ...
                        <li class="nav-item">
                            <ul>
                                <li class="nav-item">
                                    <a href="add-certificate" class="group">
                                        <div class="flex items-center">
                                        <svg
                                                    class="shrink-0 group-hover:!text-primary"
                                                    width="20"
                                            ...
                                            <span class="text-black ltr:pl-3 rtl:pr-3 dark:text-[#506690] dark:group-hover:text-white-dark">Add Certificate</span>
                                        </div>
                                    </a>
                                </li>
                                <li class="nav-item">
                                    <a href="view-certificate" class="group">
                                        <div class="flex items-center">
                                            <svg
                                                class="shrink-0 group-hover:!text-primary"
                                                width="20"
                                            ...
                                            <span class="text-black ltr:pl-3 rtl:pr-3 dark:text-[#506690] dark:group-hover:text-white-dark">View Certificate</span>
                                        </div>
                                    </a>
                                </li>
                        ...
                        <li class="menu nav-item">
                            <a href="add-subscriptions" class="nav-link group">
                                <div class="flex items-center">
                                    <svg
                                        class="shrink-0 group-hover:!text-primary"
                                        width="20"
                                    ...
                                    <span class="text-black ltr:pl-3 rtl:pr-3 dark:text-[#506690] dark:group-hover:text-white-dark">Create Subscriptions User</span>
                                </div>
                            </a>
                        </li>
                        <li class="menu nav-item">
                            <a href="view-subscription-user" class="nav-link group">
                                <div class="flex items-center">
                                    <svg
                                        class="shrink-0 group-hover:!text-primary"
                                        width="20"
                                    ...
                                    <span class="text-black ltr:pl-3 rtl:pr-3 dark:text-[#506690] dark:group-hover:text-white-dark">View Subscriptions User</span>
                                </div>
                            </a>
                        </li>

                        <li class="menu nav-item">
                            <a href="subscription-product" class="nav-link group">
                                <div class="flex items-center">
                                    <svg
                                        class="shrink-0 group-hover:!text-primary"
                                        width="20"
                                    ...
                                    <span class="text-black ltr:pl-3 rtl:pr-3 dark:text-[#506690] dark:group-hover:text-white-dark"> Subscriptions User Product</span>
                                </div>
                            </a>
                        </li>

                        <li class="menu nav-item">
                            <a href="subscription-apply" class="nav-link group">
                                <div class="flex items-center">
                                    <svg
                                        class="shrink-0 group-hover:!text-primary"
                                        width="20"
                                    ...
                                    <span class="text-black ltr:pl-3 rtl:pr-3 dark:text-[#506690] dark:group-hover:text-white-dark">Applied Subscriptions User </span>
                                </div>
                            </a>
                        </li>
                        ...
                        <li class="menu nav-item">
                            <a href="add-buyer" class="nav-link group">
                                <div class="flex items-center">
                                    <svg
                                        class="shrink-0 group-hover:!text-primary"
                                        width="20"
                                    ...
                                    <span class="text-black ltr:pl-3 rtl:pr-3 dark:text-[#506690] dark:group-hover:text-white-dark">Add Buyers</span>
                                </div>
                            </a>
                        </li>
                        <li class="menu nav-item">
                            <a href="view-buyer" class="nav-link group">
                                <div class="flex items-center">
                                    <svg
                                        class="shrink-0 group-hover:!text-primary"
                                        width="20"
                                    ...
                                    <span class="text-black ltr:pl-3 rtl:pr-3 dark:text-[#506690] dark:group-hover:text-white-dark">View  Buyers</span>
                                </div>
                            </a>
                        </li>
                        ...
                        <li class="menu nav-item">
                            <a href="add-supplier" class="nav-link group">
                                <div class="flex items-center">
                                    <svg
                                        class="shrink-0 group-hover:!text-primary"
                                        width="20"
                                    ...
                                    <span class="text-black ltr:pl-3 rtl:pr-3 dark:text-[#506690] dark:group-hover:text-white-dark">Add Suppliers</span>
                                </div>
                            </a>
                        </li>

                        <li class="menu nav-item">
                            <a href="view_supplier" class="nav-link group">
                                <div class="flex items-center">
                                    <svg
                                        class="shrink-0 group-hover:!text-primary"
                                        width="20"
                                    ...
                                    <span class="text-black ltr:pl-3 rtl:pr-3 dark:text-[#506690] dark:group-hover:text-white-dark">View Suppliers</span>
                                </div>
                            </a>
                        </li>
                        ...
                        <li class="menu nav-item">
                            <a href="Product-Purchase" class="nav-link group">
                                <div class="flex items-center">
                                    <svg
                                        class="shrink-0 group-hover:!text-primary"
                                        width="20"
                                    ...
                                    <span class="text-black ltr:pl-3 rtl:pr-3 dark:text-[#506690] dark:group-hover:text-white-dark">Product Purchase list</span>
                                </div>
                            </a>
                        </li>
                        <li class="menu nav-item">
                            <a href="Enquiry" class="nav-link group">
                                <div class="flex items-center">
                                    <svg
                                        class="shrink-0 group-hover:!text-primary"
                                        width="20"
                                    ...
                                    <span class="text-black ltr:pl-3 rtl:pr-3 dark:text-[#506690] dark:group-hover:text-white-dark">Enquiry Form List</span>
                                </div>
                            </a>
                        </li>
                        ...
                        <li class="menu nav-item">
                            <a href="complaint" class="nav-link group">
                                <div class="flex items-center">
                                    <svg
                                        class="shrink-0 group-hover:!text-primary"
                                        width="20"
                                    ...
                                    <span class="text-black ltr:pl-3 rtl:pr-3 dark:text-[#506690] dark:group-hover:text-white-dark">Complaint List</span>
                                </div>
                            </a>
                        </li>
                        ...
                        <li class="menu nav-item">
                           ...
                           <button
                                ...
                                <svg
                                    ...
                                    <span class="text-black ltr:pl-3 rtl:pr-3 dark:text-[#506690] dark:group-hover:text-white-dark">Forgot Password  </span>
                                </div>
