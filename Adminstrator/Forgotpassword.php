...
if($username=="")
{
	echo"<script>alert('You has Logged Out.Please Login!..');
		 window.location.href='index';</script>"; //redirect user to login page
}
...
if(isset($_POST['submit']))
{
	...
	if($np!=$cp)
	{
		echo"<script>alert('New & Confirm Password do not Match! Try Again...');</script>";
	}
	else
	{
		$query=mysqli_query($conn,"SELECT password from tbl_admin where password='$op'");
		if(mysqli_num_rows($query)>0)
		{
			$result=mysqli_query($conn,"update tbl_admin set password='$np' where password='$op'");
			if($result==true)
			{
				  echo"<script>alert(' Ohh Yes! Password change successfully');</script>";
		...
		{
			echo  "<script>alert('Old and Current Password do not Match! Try Again...');</script>";
		}
	}
}

$ToEmail = 'aayushglobalconnection21@gmail.com';
                                ...
                                <div>
                                    ...
                                    <div>
                                        <label class="flex cursor-pointer items-center">
                                            <input type="checkbox" class="form-checkbox bg-white dark:bg-black" required />
                                            <span class="text-white-dark">Please Check Terms & Condition</span>
                                        </label>
                                    </div>
                                    <button
