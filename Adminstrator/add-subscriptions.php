...
$queryy="INSERT INTO  tbl_subscription_user(username,password,plan_type,subscription_date) VALUES('$user','$password','$plan','$date')";	 
$run=mysqli_query($conn,$queryy);
if($run==true)
{
$_SESSION['status']="Country Saved Seccessfully..";
        $_SESSION['status_code']="success";
				 ?>
		 <script>
		 setTimeout(function () {
       window.location.href = "view-subscription-user"; //will redirect to your stud_registration page after 3000 ms
    }, 1000);
	</script>
	<?php 
}
                ...
                <div class="dvanimation animate__animated p-6" :class="[$store.app.animation]">
                    ...
                    <div>
                        ...
                        <div class="flex flex-wrap items-center justify-between gap-4">
                            <h2 class="text-xl mb-2">Add New Subscription User</h2>
                            <div class="flex w-full flex-col gap-4 sm:w-auto sm:flex-row sm:items-center sm:gap-3">
                                <div class="flex gap-3">
                                    <div>
                                        <a href="view-subscription-user">
                                            <button type="button" class="btn btn-primary mb-2">

                                                View All Subscription User
                                            </button>
                                        </a>
                                ...
                                <template x-if="tab === 'home'">
                                    <div>
                                        <form method="post" class="mb-5 rounded-md border border-[#ebedf2] bg-white p-4 dark:border-[#191e3a] dark:bg-[#0e1726]">
                                            <h6 class="mb-5 text-lg font-bold">Create New Subscription User</h6>
                                            <div class="flex flex-col sm:flex-row">
                                                 
                                                <div class="grid flex-1 grid-cols-1 gap-5 sm:grid-cols-2">
                                                    <div>
                                                        <label for="name">Username Name</label>
                                                        <input id="name" name="username" type="text" required placeholder="Jimmy Turner" class="form-input" />
                                                    </div>
                                                    <div>
                                                        <label for="profession">User Password</label>
                                                        <input name="password" id="profession" type="text" required placeholder="password" class="form-input" />
                                                    </div>
                                                    <div>
                                                        <label for="country">Select Subscriptions</label>
                                                        <select name="plan" id="country" required class="form-select text-white-dark">
                                            ...
                                            <option value="Diamond Plan">Diamond Plan</option>
                                                    ...
                                                    <div>
                                                        ...
                                                        <input name="date" id="datePicker" min="<?php echo $currentDate; ?>" required type="date" placeholder="New York" class="form-input" />
                                                    </div>
