...
if ($_SERVER['REQUEST_METHOD'] == 'POST' && isset($_POST['submit'])) {
    ...
    $username = mysqli_real_escape_string($conn, htmlentities(trim($username)));
...
if (isset($_SESSION['status'])) {
    echo "<div class='status-message " . $_SESSION['status_code'] . "'>" . $_SESSION['status'] . "</div>";
    unset($_SESSION['status']);  // Clear the status after displaying it
}
?>

<?php
// Check if the error session is set, then show an alert message
                ...
                <div
                    ...
                    <div
                        ...
                        <div class="mx-auto w-full max-w-[440px]">
                            <div class="mb-10">
                                <img src="assets/images/1.svg" alt="" srcset="" style="display: block;
  margin-left: auto;
  margin-right: auto;
                            ...
                            <form class="space-y-5 dark:text-white" method="POST">
                                <div>
                                    ...
                                    <div class="relative text-white-dark">
                                        <input   type="text" name="user" placeholder="Enter Email" class="form-input ps-10 placeholder:text-white-dark" />
