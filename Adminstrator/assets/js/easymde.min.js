            ...
            String.prototype.normalize
              ...
              (p.prototype = {
                ...
                find: function (t) {
                  ...
                  if (
                    ((this.afterEmptyMatch = i && 0 == e.cmpPos(i.from, i.to)),
                    i)
                  )
                    return (
                      (this.pos = i),
          ...
          !(function (e, r) {
            ...
            function rn(e, t, n) {
              (this.line = t),
                ...
                (this.size = this.rest ? Ze(X(this.rest)) - n + 1 : 1),
            ...
            function Fr(e) {
              for (
                ...
                if (!u.hidden) {
                  ...
                  if (
                    (m > 0.005 || m < -0.005) &&
                    (i < r && (o -= m), Ke(u.line, d), Ar(u.line), u.rest)
                  )
            ...
            function Nr(e) {
              ...
              t &&
                ...
                Or(e, Xn(e, t.from), Xn(e, t.to), t.margin));
            }
            function Or(e, t, n, r) {
              var i = Tr(e, {
            ...
            function Di(e, t) {
              ...
              if ((i && c) || (o && h)) {
                ...
                if (i && !n && !d && null != a)
                  return (
                    o && h && Ir(e, Math.max(0, u.scrollTop + o * a)),
                    Hr(e, Math.max(0, u.scrollLeft + i * a)),
                    (!o || (o && h)) && ye(t),
            ...
            function Ko(e, t) {
              ...
              return (
                null != n &&
                !e.altGraphKey &&
                (3 == e.keyCode && e.code && (n = e.code), Xo(n, e, t))
              );
            }
            function Zo(e) {
              ...
              for (
                ...
                f.empty() &&
                  (n && n > 0
                    ...
                    ? (m = et(
                        m.line,
                        Math.min(Ge(o, m.line).text.length, m.ch + X(s).length)
                      ))
                    : l &&
                      La &&
                      La.lineWise &&
              ...
              function k(e, t, n) {
                ...
                if ("endTag" == e || "selfcloseTag" == e) {
                  ...
                  return (
                    ...
                    "selfcloseTag" == e ||
                    s.autoSelfClosers.hasOwnProperty(m(r))
                      ? x(n, r)
                      : (x(n, r), (n.context = new g(n, r, i == n.indented))),
                    y
                  );
                }
                return (a = "error"), k;
                  ...
                  indent: function (t, n, r) {
                    ...
                    if (o && o[1])
                      for (; i; ) {
                        ...
                        if (!s.implicitlyClosed.hasOwnProperty(m(i.tagName)))
                          break;
                        i = i.prev;
                      }
                    else if (o)
                    ...
                    if (t) {
                      ...
                      if (n.header.length === n.align.length) {
                        ...
                        for (l = n.rows.length, r = 0; r < l; r++)
                          n.rows[r] = S(n.rows[r], n.header.length).map(
                            function (e) {
                              return { text: e };
                            }
                          );
                      ...
                      if (
                        ...
                        if ((n = this.tokenizer.escape(e)))
                          ...
                          if (
                            ...
                            (n = this.tokenizer.inlineText(i, N)))
                          )
                            (e = e.substring(n.raw.length)),
            ...
            function _(e, t, n) {
              ...
              if (
                ...
                var o = function (e) {
                  ...
                  if (!e)
                    try {
                      t.walkTokens && _.walkTokens(r, t.walkTokens),
                        (o = P.parse(r, t));
                    } catch (t) {
                      e = t;
                    }
              ...
              try {
                var l = I.lex(e, t);
                return (
                  t.walkTokens && _.walkTokens(l, t.walkTokens), P.parse(l, t)
                );
              } catch (e) {
                if (
                  ((e.message +=
      ...
      18: [
        function (e, t, n) {
          ...
          function v(e, t, n, r, i, o) {
            ...
            l.tabIndex = -1;
            for (
              var m = document.createElement("i"), g = 0;
              g < h.length;
              g++
            ) {
              var v = h[g];
            ...
            if (
              ...
              for (
                ...
                !(function (n) {
                  ...
                  o[t]
                    ? (r = r.replace(s[t], "$1"))
                    : ("unordered-list" == t && (r = u("ordered-list", r, !0)),
                      (r = u(t, r, !1)),
                      (c += 1)),
                    e.replaceRange(
                      r,
                ...
                if (
                  ...
                  !1 !== o.spellChecker &&
                    ...
                    "function" == typeof o.spellChecker
                      ? o.spellChecker({ codeMirrorInstance: r })
            ...
            (ae.prototype.uploadImage = function (e, t, n) {
              ...
              function o(t) {
                ...
                return t
                  ...
                  .replace("#image_size#", K(e.size, n))
                  .replace("#image_max_size#", K(r.options.imageMaxSize, n));
              }
              if (
                ((t =
                  t ||
                ...
                function (e) {
                  var r = (function (e) {
                    ...
                    return e
                      ...
                      .replace("#image_size#", K(t.size, r))
                      .replace(
                        "#image_max_size#",
                        K(n.options.imageMaxSize, r)
                      );
                  })(e);
