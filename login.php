...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    $query = "SELECT * FROM tbl_subscription_user WHERE username='$username' AND password='$password' AND plan_type='$plan'";
    ...
    if (mysqli_num_rows($result) > 0) {
        ...
        $error_message = "Invalid username or password & Plan.";
    }
}
?>
